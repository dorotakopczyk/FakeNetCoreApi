...
namespace SampleMVCApp.Api.Services
{
    public class DataSeeder : IDataSeeder
    {
        public async Task Initialize(FoodDbContext context)
        {
            ...
            context.FoodItems.Add(new FoodItem() { Calories = 500, Name = "Turkey Leg", Type = "Main", Created = DateTime.Now });
            context.FoodItems.Add(new FoodItem() { Calories = 750, Name = "Avocado", Created = DateTime.Now });
            context.FoodItems.Add(new FoodItem() { Calories = 1000, Name = "Cheesecake",Type = "Dessert", Created = DateTime.Now });
            context.FoodItems.Add(new FoodItem() { Calories = 250, Name = "Banana", Type = "Fruit", Created = DateTime.Now });
            context.FoodItems.Add(new FoodItem() { Calories = 500, Name = "Shepherds Pie", Type = "Main", Created = DateTime.Now });
            context.FoodItems.Add(new FoodItem() { Calories = 750, Name = "Filet Mignon", Created = DateTime.Now });
            context.FoodItems.Add(new FoodItem() { Calories = 1000, Name = "Chana Masala", Type = "Main", Created = DateTime.Now });
